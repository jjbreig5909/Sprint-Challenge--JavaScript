...
const unisWithUni = graduates.filter((element) => {
...
lowCaseAnimalNames.push(zooAnimals.map(name => name.animal_name.toLowerCase()))
...
*/
const populationTotal = zooAnimals.reduce((acc, zooAnimal) => acc + zooAnimal.population, 0);
